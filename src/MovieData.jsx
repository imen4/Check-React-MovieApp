export const movieData = [
  { 
    ...
    rating: 4,
    image:
      "https://cdn1.cinenode.com/movie_poster/2/persuasion-2014-264-432.jpg",
    description:
      "Angleterre. 1814. Anne Elliot retrouve Frederick Wentworth, un capitaine de marine qu'elle avait repoussé alors qu'elle avait 19 ans et lui 23, persuadée par sa famille que ce n'était pas un mari qui lui conviendrait. Huit ans après, Anne retombe sous le charme de son ancien fiancé, tandis que lui semble indifférent...",
  ...
  },
  {
    ...
    rating: 3,
    image:
      "https://m.media-amazon.com/images/M/MV5BNjU0Mjc0NzU3NF5BMl5BanBnXkFtZTcwMTU4OTkwNA@@._V1_.jpg",
    description:
    ...
    },
  {
    ...
    rating: 2,
    image: "https://m.media-amazon.com/images/I/51r4i5VQK3L._AC_SY580_.jpg",
...
},
 {
    ...
    title: "Parasite",
    rating: 1,
    image: "https://miro.medium.com/max/897/1*A7RgSOPsn2IGETH4R1A2tw.jpeg",
    description: "The Kims - mother and father Chung-sook and Ki-taek, and their young adult offspring, son Ki-woo and daughter Ki-jung - are a poor family living in a shabby and cramped half basement apartment in a busy lower working class commercial district of Seoul.",
    year:"September 14, 2016"
